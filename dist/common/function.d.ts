...
declare function previewTransaction(networkId: number, manifest: TransactionManifest, notaryPublicKey: PublicKey, signerPublicKeys: PublicKey[], blobsHex: string[]): Promise<PreviewResult>;
